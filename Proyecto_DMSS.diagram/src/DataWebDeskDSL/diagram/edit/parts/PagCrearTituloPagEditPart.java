 ...
 * @generated
 */
public class PagCrearTituloPagEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.PagCrearTituloPagEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PagCrearTituloPagEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.PagCrear_2001, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new PagCrearLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PagCrearLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PagCrearLabelFigure() {
			this.setText("PagCrear");
		}
