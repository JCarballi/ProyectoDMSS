 ...
 * @generated
 */
public class RolNombreRolEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.RolNombreRolEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public RolNombreRolEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.Rol_2012, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new RolLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RolLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RolLabelFigure() {
			this.setText("Rol");
		}
