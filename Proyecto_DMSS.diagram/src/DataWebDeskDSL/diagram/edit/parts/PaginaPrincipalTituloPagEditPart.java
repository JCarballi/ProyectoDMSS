 ...
 * @generated
 */
public class PaginaPrincipalTituloPagEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry.getType(
				DataWebDeskDSL.diagram.edit.parts.PaginaPrincipalTituloPagEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PaginaPrincipalTituloPagEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PaginaPrincipalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PaginaPrincipalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PaginaPrincipalLabelFigure() {
			this.setText("PaginaPrincipal");
		}
