 ...
 * @generated
 */
public class CaracteristicaEntidadNombreCaractEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CaracteristicaEntidadNombreCaractEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					...
					getParserElement(), DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry.getType(
