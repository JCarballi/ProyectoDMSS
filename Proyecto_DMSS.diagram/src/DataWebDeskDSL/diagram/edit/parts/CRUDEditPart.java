 ...
 * @generated
 */
public class CRUDEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DataWebDeskDSL.diagram.edit.policies.CRUDItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new CRUDFigure();
	}

	/**
	* @generated
	*/
	public CRUDFigure getPrimaryShape() {
		return (CRUDFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DataWebDeskDSL.diagram.edit.parts.CRUDTituloPagEditPart) {
	...
	*/
	 ...
	 * @generated
	 */
	public class CRUDFigure extends SVGFigure {
