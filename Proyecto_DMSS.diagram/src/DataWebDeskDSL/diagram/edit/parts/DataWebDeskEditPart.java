 ...
 * @generated
 */
public class DataWebDeskEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "DataWebDeskDSL"; //$NON-NLS-1$
	...
	* @generated
	*/
	public DataWebDeskEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DataWebDeskDSL.diagram.edit.policies.DataWebDeskItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DataWebDeskDSL.diagram.edit.policies.DataWebDeskCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new DataWebDeskDSL.diagram.edit.commands.DataWebDeskDSLCreateShortcutDecorationsCommand(
