 ...
 * @generated
 */
public class PagBorrarTituloPagEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.PagBorrarTituloPagEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PagBorrarTituloPagEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.PagBorrar_2003, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new PagBorrarLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PagBorrarLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PagBorrarLabelFigure() {
			this.setText("PagBorrar");
		}
