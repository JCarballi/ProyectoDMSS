 ...
 * @generated
 */
public class PagIndiceTituloPagEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.PagIndiceTituloPagEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PagIndiceTituloPagEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.PagIndice_2005, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new PagIndiceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PagIndiceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PagIndiceLabelFigure() {
			this.setText("PagIndice");
		}
