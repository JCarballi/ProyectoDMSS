 ...
 * @generated
 */
public class PagLeerTituloPagEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.PagLeerTituloPagEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PagLeerTituloPagEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.PagLeer_2002, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new PagLeerLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PagLeerLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PagLeerLabelFigure() {
			this.setText("PagLeer");
		}
