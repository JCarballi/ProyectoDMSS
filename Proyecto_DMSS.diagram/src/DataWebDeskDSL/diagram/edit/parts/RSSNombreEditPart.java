 ...
 * @generated
 */
public class RSSNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.RSSNombreEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public RSSNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.RSS_2011, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new RSSLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RSSLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RSSLabelFigure() {
			this.setText("RSS");
		}
