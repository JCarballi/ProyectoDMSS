 ...
 * @generated
 */
public class URLExternaLinkEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.URLExternaLinkEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public URLExternaLinkEditPart(View view) {
		super(view);
	}
