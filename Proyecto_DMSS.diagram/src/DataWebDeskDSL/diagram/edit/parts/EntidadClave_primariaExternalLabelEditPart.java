 ...
 * @generated
 */
public class EntidadClave_primariaExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry.getType(
						DataWebDeskDSL.diagram.edit.parts.EntidadClave_primariaExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public EntidadClave_primariaExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EntidadClave_primariaExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EntidadClave_primariaExternalLabelFigure extends WrappingLabel {
