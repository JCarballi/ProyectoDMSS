 ...
 * @generated
 */
public class PaginasNormalesTituloPagEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry.getType(
				DataWebDeskDSL.diagram.edit.parts.PaginasNormalesTituloPagEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PaginasNormalesTituloPagEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					...
					getParserElement(), DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					DataWebDeskDSL.diagram.edit.parts.DataWebDeskDSLEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PaginasNormalesLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PaginasNormalesLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PaginasNormalesLabelFigure() {
			this.setText("PaginasNormales");
		}
