 ...
 * @generated
 */
public class CRUDTituloPagEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.CRUDTituloPagEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public CRUDTituloPagEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.CRUD_2006, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new CRUDLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CRUDLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CRUDLabelFigure() {
			this.setText("CRUD");
		}
