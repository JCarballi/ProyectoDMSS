 ...
 * @generated
 */
public class PagActualizarTituloPagEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.PagActualizarTituloPagEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PagActualizarTituloPagEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.PagActualizar_2004, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new PagActualizarLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PagActualizarLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PagActualizarLabelFigure() {
			this.setText("PagActualizar");
		}
