 ...
 * @generated
 */
public class FacebookNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.FacebookNombreEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public FacebookNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.Facebook_2010, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new FacebookLabelFigure();
	}

	/**
	 * @generated
	 */
	public class FacebookLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public FacebookLabelFigure() {
