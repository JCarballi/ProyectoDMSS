 ...
 * @generated
 */
public class PaginaAccedeExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaAccedeExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.PaginaAccede_4001, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new PaginaAccedeExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PaginaAccedeExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PaginaAccedeExternalLabelFigure() {
			this.setText("accede");
		}
