 ...
 * @generated
 */
public class TwitterNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(DataWebDeskDSL.diagram.edit.parts.TwitterNombreEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public TwitterNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.Twitter_2009, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new TwitterLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TwitterLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TwitterLabelFigure() {
