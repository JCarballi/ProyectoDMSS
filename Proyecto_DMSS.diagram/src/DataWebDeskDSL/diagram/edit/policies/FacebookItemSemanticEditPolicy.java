 ...
 * @generated
 */
public class FacebookItemSemanticEditPolicy
		extends DataWebDeskDSL.diagram.edit.policies.DataWebDeskDSLBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public FacebookItemSemanticEditPolicy() {
		super(DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.Facebook_2010);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry.getVisualID(
					outgoingLink) == DataWebDeskDSL.diagram.edit.parts.RedSocialMostradaEditPart.VISUAL_ID) {
