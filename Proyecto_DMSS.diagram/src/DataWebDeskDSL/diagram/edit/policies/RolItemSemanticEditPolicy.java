...
public class RolItemSemanticEditPolicy
	...
	*/
	public RolItemSemanticEditPolicy() {
		super(DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.Rol_2012);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
					.getVisualID(outgoingLink) == DataWebDeskDSL.diagram.edit.parts.RolTiene_accesoEditPart.VISUAL_ID) {
