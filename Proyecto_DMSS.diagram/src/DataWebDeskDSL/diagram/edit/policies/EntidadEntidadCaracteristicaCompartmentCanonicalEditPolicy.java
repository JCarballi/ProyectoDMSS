 ...
 * @generated
 */
public class EntidadEntidadCaracteristicaCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DataWebDeskDSL.DataWebDeskDSLPackage.eINSTANCE.getEntidad_Caracteristica();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getEntidadEntidadCaracteristicaCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return DataWebDeskDSL.diagram.edit.parts.CaracteristicaEntidadEditPart.VISUAL_ID == DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getEntidadEntidadCaracteristicaCompartment_7001SemanticChildren((View) getHost().getModel());
