 ...
 * @generated
 */
public class DataWebDeskCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(DataWebDeskDSL.DataWebDeskDSLPackage.eINSTANCE.getDataWebDesk_Pagina());
			myFeaturesToSynchronize.add(DataWebDeskDSL.DataWebDeskDSLPackage.eINSTANCE.getDataWebDesk_Redsocial());
			myFeaturesToSynchronize.add(DataWebDeskDSL.DataWebDeskDSLPackage.eINSTANCE.getDataWebDesk_Rol());
			myFeaturesToSynchronize.add(DataWebDeskDSL.DataWebDeskDSLPackage.eINSTANCE.getDataWebDesk_Entidad());
			myFeaturesToSynchronize.add(DataWebDeskDSL.DataWebDeskDSLPackage.eINSTANCE.getDataWebDesk_Urlexterna());
		}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getDataWebDesk_1000SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getDataWebDesk_1000SemanticChildren((View) getHost().getModel());
	...
	*/
	private Collection<DataWebDeskDSL.diagram.part.DataWebDeskDSLLinkDescriptor> collectAllLinks(View view,
		...
		case DataWebDeskDSL.diagram.edit.parts.DataWebDeskEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
						.getDataWebDesk_1000ContainedLinks(view));
			}
		...
		case DataWebDeskDSL.diagram.edit.parts.PagCrearEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater.getPagCrear_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.PagLeerEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater.getPagLeer_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.PagBorrarEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater.getPagBorrar_2003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.PagActualizarEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
						.getPagActualizar_2004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.PagIndiceEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater.getPagIndice_2005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.CRUDEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater.getCRUD_2006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.PaginasNormalesEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
						.getPaginasNormales_2007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.PaginaPrincipalEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
						.getPaginaPrincipal_2008ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.TwitterEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater.getTwitter_2009ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.FacebookEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater.getFacebook_2010ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.RSSEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater.getRSS_2011ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.RolEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater.getRol_2012ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.EntidadEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater.getEntidad_2013ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.URLExternaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
						.getURLExterna_2014ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DataWebDeskDSL.diagram.edit.parts.CaracteristicaEntidadEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
						.getCaracteristicaEntidad_3001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
