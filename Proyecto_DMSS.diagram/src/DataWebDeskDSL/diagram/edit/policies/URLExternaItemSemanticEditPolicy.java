 ...
 * @generated
 */
public class URLExternaItemSemanticEditPolicy
		extends DataWebDeskDSL.diagram.edit.policies.DataWebDeskDSLBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public URLExternaItemSemanticEditPolicy() {
		super(DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.URLExterna_2014);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry.getVisualID(
					outgoingLink) == DataWebDeskDSL.diagram.edit.parts.URLExternaPaginaEditPart.VISUAL_ID) {
