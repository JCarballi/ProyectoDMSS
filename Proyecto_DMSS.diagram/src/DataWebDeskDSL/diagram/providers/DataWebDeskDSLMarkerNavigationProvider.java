 ...
 * @generated
 */
public class DataWebDeskDSLMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramEditorUtil.selectElementsInDiagram(editor,
