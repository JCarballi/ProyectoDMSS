 ...
 * @generated
 */
public class DataWebDeskDSLModelingAssistantProviderOfURLExternaEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((DataWebDeskDSL.diagram.edit.parts.URLExternaEditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(DataWebDeskDSL.diagram.edit.parts.URLExternaEditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((DataWebDeskDSL.diagram.edit.parts.URLExternaEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			DataWebDeskDSL.diagram.edit.parts.URLExternaEditPart source, IGraphicalEditPart targetEditPart) {
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((DataWebDeskDSL.diagram.edit.parts.URLExternaEditPart) sourceEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(DataWebDeskDSL.diagram.edit.parts.URLExternaEditPart source,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == DataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.URLExternaPagina_4007) {
