 ...
 * @generated
 */
public class DataWebDeskDSLValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && DataWebDeskDSL.diagram.edit.parts.DataWebDeskEditPart.MODEL_ID
