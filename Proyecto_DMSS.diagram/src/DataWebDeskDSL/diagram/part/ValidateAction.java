...
public class ValidateAction extends Action {
	...
	*/
	public ValidateAction(IWorkbenchPage page) {
		setText(DataWebDeskDSL.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	*/
	public static void runValidation(View view) {
		try {
			if (DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		DataWebDeskDSL.diagram.providers.DataWebDeskDSLValidationProvider.runWithConstraints(txDomain, new Runnable() {
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			DataWebDeskDSL.diagram.providers.DataWebDeskDSLMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	*/
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(),
				collectTargetElements(rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramEditorUtil.findView(diagramEditPart,
	...
	*/
	private static void addMarker(EditPartViewer viewer, IFile target, String elementId, String location,
		...
		DataWebDeskDSL.diagram.providers.DataWebDeskDSLMarkerNavigationProvider.addMarker(target, elementId, location,
