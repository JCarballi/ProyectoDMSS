 ...
 * @generated
 */
public class DataWebDeskDSLDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public DataWebDeskDSLDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof DataWebDeskDSL.diagram.navigator.DataWebDeskDSLDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((DataWebDeskDSL.diagram.navigator.DataWebDeskDSLDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new DataWebDeskDSL.diagram.navigator.DataWebDeskDSLDomainNavigatorItem((EObject) objects[i],
