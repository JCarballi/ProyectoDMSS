 ...
 * 
 */
package DataWebDeskDSL.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(DataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(DataWebDeskDSL.diagram.part.Messages.MessageFormatParser_InvalidInputError,
