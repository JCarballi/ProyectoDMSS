...
/**
 * This is the item provider adapter for a {@link DataWebDeskDSL.Twitter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TwitterItemProvider extends RedSocialItemProvider {
	/**
	...
	public String getText(Object object) {
		tipoContenido labelValue = ((Twitter)object).getTipoCont();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Twitter_type") :
